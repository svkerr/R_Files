...
The bridge data for this analysis was obtained from [Virginia Department of Transportation](http://www.virginiadot.org/info/bridge.asp)

### Description of the Bridge Age

Virginia has some of the oldest bridges in the United States, where the oldest bridge was built in `r min(bridges$Year.Built.Numeric)`. In fact, there are `r nrow(subset(bridges, Year.Built.Numeric <= 1900))` bridges that were built in 1900 or earlier. 
